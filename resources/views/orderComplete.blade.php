...
@section('title', '800Benaa | Order Complete')
            ...
            <div class="order-success__body">
                <div class="order-success__header">
                    <svg class="order-success__icon" width="100" height="100">
                        <use xlink:href="{{asset('public/images/sprite.svg#check-100')}}"></use>
                    </svg>
                    <h1 class="order-success__title">Thank you</h1>
                    <div class="order-success__subtitle">Your order has been received</div>
                    <div class="order-success__actions">
                        <a href="{{URL::to('/')}}" class="btn btn-xs btn-secondary">Go To Homepage</a>
                    </div>
                </div>
